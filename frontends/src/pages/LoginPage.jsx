            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <div className="relative flex items-center">
                  <input name="username" id='username' value={values.username} onChange={handleChange} onBlur={handleBlur} type="text" required class="w-full text-sm text-slate-900 border border-slate-300 pl-4 pr-10 py-3 rounded-lg outline-blue-600" placeholder="Enter user name" />
              ...
              <div className="!mt-12">
                ...
                <p className="text-sm !mt-6 text-center text-slate-600">Don't have an account <a href="javascript:void(0);" class="text-blue-600 font-medium hover:underline ml-1 whitespace-nowrap">Register here</a></p>
              </div>
            </form>
          </div>
